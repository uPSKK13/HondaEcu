...
class HondaECU_TunePanelHelper(HondaECU_AppPanel):
	...
	def Build(self):
		...
		tunepickerpsizer.Add(self.newrp, pos=(0,0), flag=wx.ALIGN_RIGHT|wx.EXPAND|wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, border=10)
		tunepickerpsizer.Add(self.openrp, pos=(1,0), flag=wx.ALIGN_RIGHT|wx.EXPAND|wx.TOP|wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, border=10)
		tunepickerpsizer.Add(self.newp, pos=(0,1), flag=wx.ALIGN_RIGHT|wx.EXPAND|wx.ALL|wx.ALIGN_CENTER_VERTICAL, border=0)
		tunepickerpsizer.Add(self.openp, pos=(1,1), flag=wx.ALIGN_RIGHT|wx.EXPAND|wx.TOP|wx.ALIGN_CENTER_VERTICAL, border=10)
		tunepickerpsizer.Add(self.continueb, pos=(2,0), span=(1,2), flag=wx.ALIGN_RIGHT|wx.TOP|wx.ALIGN_CENTER_VERTICAL, border=10)
