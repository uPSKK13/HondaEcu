...
class HondaECU_EEPROMPanel(HondaECU_AppPanel):
	...
	def Build(self):
		...
		self.eeprompsizer.Add(self.progressboxp, pos=(1,0), span=(1,6), flag=wx.BOTTOM|wx.LEFT|wx.RIGHT|wx.EXPAND|wx.TOP, border=20)
		self.eeprompsizer.Add(self.modebox, pos=(2,0), span=(1,2), flag=wx.ALIGN_LEFT|wx.ALIGN_BOTTOM|wx.LEFT, border=10)
