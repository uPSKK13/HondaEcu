...
if __name__ == '__main__':
	...
	if args.mode == "read":
		...
		# <- 0x0d 0x0a 0x01 0x20 0x20 0x20 0x20 0x20 0x20 0x28 | this shows up in ECU bin
		ecu.send_command([0x7d], [0x01, 0x01, 0x01], debug=args.debug)
		# <- 0x0d 0x05 0x01 0x7b 0x72
		...
		# <- 0x0d 0x09 0x01 0x01 0x00 0x00 0x00 0x00 0xe8
		...
		# -> 0x7e 0x05 0x01 0x02 0x7a
		# <- 0x0e 0x07 0x02 0x00 0x6c 0x54 0x29

		# -> 0x7e 0x07 0x01 0x03 0x00 0x00 0x77
		# <- 0x0e 0x05 0x03 0x00 0xea

		# -> 0x7e 0x06 0x01 0x01 0x00 0x7a
		# <- 0x0e 0x05 0x01 0x10 0xdc

		# -> 0x7e 0x0b 0x01 0x0b 0x00 0x00 0x00 0xff 0xff 0xff 0x6e | this in ecu
		# <- 0x0e 0x05 0x0b 0x00 0xe2

		# -> 0x7e 0x06 0x01 0x01 0x00 0x7a
		# <- 0x0e 0x05 0x01 0x20 0xcc

		# -> 0x7e 0x07 0x01 0x0e 0x01 0x90 0xdb
		# <- 0x0e 0x04 0x0e 0xe0

		# -> 0x7e 0x06 0x01 0x01 0x01 0x79
		# <- 0x0e 0x06 0x01 0x00 0x00 0xeb

		# -> 0x7e 0x06 0x01 0x04 0xff 0x78
		# <- 0x0e 0x05 0x04 0x00 0xe9

		# -> 0x7e 0x06 0x01 0x01 0x00 0x7a
		# <- 0x0e 0x05 0x01 0x20 0xcc

		# -> 0x7e 0x05 0x01 0x05 0x77
