...
class DataPanel(wx.Panel):
	...
	def __init__(self, gui):
		...
		self.datapsizer.Add(enginespeedl, pos=(0,0), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		...
		self.datapsizer.Add(o2volt1l, pos=(15,0), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(o2heat1l, pos=(16,0), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(sttrim1l, pos=(17,0), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)

		self.datapsizer.Add(o2volt2l, pos=(0,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(o2heat2l, pos=(1,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(sttrim2l, pos=(2,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(basvl, pos=(3,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(egcvil, pos=(4,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(egcvtl, pos=(5,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(egcvll, pos=(6,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(lscl, pos=(7,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(lstl, pos=(8,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(lsvl, pos=(9,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(oscl, pos=(10,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(estl, pos=(11,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(icsl, pos=(12,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(ersl, pos=(13,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(scsl, pos=(14,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(fpcl, pos=(15,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(intakeairl, pos=(16,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(pairvl, pos=(17,2), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)

		self.datapsizer.Add(fc1l, pos=(0,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(basl, pos=(1,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(esl, pos=(2,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(mstsl, pos=(3,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(lsl, pos=(4,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(otssl, pos=(5,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(lysl, pos=(6,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(otscl, pos=(7,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(evapl, pos=(8,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(vtecl, pos=(9,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(pcvl, pos=(10,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(startersl, pos=(11,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(startercl, pos=(12,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(fc2l, pos=(13,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(gearsl, pos=(14,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(startervl, pos=(15,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(mainrl, pos=(16,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
		self.datapsizer.Add(filampl, pos=(17,4), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT, border=0)
...
class HondaECU_GUI(wx.Frame):
	...
	def __init__(self, args, usbcontext):
		...
		wx.Frame.__init__(self, None, title="HondaECU", size=(600,460), style=wx.DEFAULT_FRAME_STYLE & ~(wx.RESIZE_BORDER | wx.MAXIMIZE_BOX))
